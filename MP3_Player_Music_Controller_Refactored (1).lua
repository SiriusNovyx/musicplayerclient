...
g.Parent=f
return f end
UI.listPanel=createSidePanel("ListPanel",UDim2.new(0,Cfg.LIST_WIDTH,1,0),UDim2.new(0,0,0,0))
...
UI.queuePanel=createSidePanel("QueuePanel",UDim2.new(0,Cfg.LIST_WIDTH,1,0),UDim2.new(1,-Cfg.LIST_WIDTH,0,0))
...
_lyricsTween=nil end
	...
	task.delay(1.0,function()
		...
		local cinConn;cinConn=Svc.RunService.Heartbeat:Connect(function()
			...
			lbl.BackgroundTransparency=1;lbl.Font=Enum.Font.GothamBold;lbl.Text=text;lbl.TextColor3=C.TEXT;lbl.TextSize=54;lbl.RichText=false;lbl.TextXAlignment=Enum.TextXAlignment.Left;lbl.TextTransparency=1;lbl.TextStrokeTransparency=1;lbl.TextStrokeColor3=C.BG;lbl.ZIndex=101;lbl.TextWrapped=true;lbl.Parent=sg
